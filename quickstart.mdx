...
<Card title="Parse content" icon="file" href="/ingestion/parsing">
  Learn about different document parsing functions.
</Card>

<Card title="Extract structured outputs" icon="table" href="/ingestion/extraction">
  Learn best practices to ensure reliable structured outputs.
</Card>

<Card title="Agentic chunking" icon="brain" href="/ingestion/agentic_chunking">
  Learn how to get contextually rich chunks so your agent never misses critical context.
</Card>

<Card title="API reference" icon="book-open" href="/api-reference/create-ingestion-job">
