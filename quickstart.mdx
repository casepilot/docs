...
The Parsing API processes and extracts data from various file formats using multi-stage pipelines. 
It supports common enrichment requirements like content classification, document splitting, and contextual chunking. 
